...
def split_protected_variable(raw_data, S_id):
    ...
    raw_data['Country'][raw_data['Country'].str.contains('United-States') == False] = 'Non-US'  # noqa
    # Compress workclass as Private / non-Private
    raw_data['Workclass'][raw_data['Workclass'].str.contains('Private') == False] = 'Non-Private'  # noqa
    # Compress race as White / non-White
    raw_data['Race'][raw_data['Race'].str.contains('White') == False] = 'Non-White'  # noqa
    # Drop relationship
